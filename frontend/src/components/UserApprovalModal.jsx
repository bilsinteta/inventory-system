                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <select
                                                ...
                                                className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-100 w-32"
                                            >
                                        ...
                                        {/* Actions */}
                                        <div className="flex flex-col gap-1">
                                            <label className="text-[10px] uppercase font-bold text-gray-400">Action</label>
                                            <div className="flex gap-2">
                                                {!user.is_active ? (
                                                    ...
                                                    <button
                                                        onClick={() => handleUpdateUser(user, tempRole[user.id], true)} // Keep active, just update role
                                                        disabled={tempRole[user.id] === user.role} // Disable if no change
                                                ...
                                                {/* Optional: Add Deactivate/Delete button later if needed */}
                                            </div>
                                        </div>
                                    </div>
                                </div>
